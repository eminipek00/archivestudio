...
const LoginPage = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Eğer girilen değer e-posta değilse (kullanıcı adıysa), e-postayı profiles tablosundan bul
    if (!identity.includes("@")) {
      ...
      if (data?.email) {
        ...
        setMessage("Hata: Kullanıcı adı bulunamadı.");
        setLoading(false);
        return;
      }
    }
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-muted/50 border border-border-custom rounded-xl py-4 pl-11 pr-4 focus:outline-none focus:ring-1 focus:ring-primary transition-all text-sm font-bold"
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-muted/50 border border-border-custom rounded-xl py-4 pl-11 pr-12 focus:outline-none focus:ring-1 focus:ring-primary transition-all text-sm font-bold"
                placeholder="••••••••"
                required
              />
              <button 
