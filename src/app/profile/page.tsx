...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-background no-scrollbar">
      ...
      <main className="max-w-4xl mx-auto px-4 pt-28 pb-12 space-y-6">
          <div className="flex flex-col md:flex-row items-center gap-8 bg-card border border-border-custom p-6 md:p-8 rounded-[3rem] shadow-xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            <div className="space-y-6">
                <form onSubmit={handleUpdateProfile} className="bg-card border border-border-custom p-6 md:p-8 rounded-[3rem] shadow-xl flex flex-col gap-6">
                    <div className="flex items-center justify-between border-b border-white/5 pb-4">
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-primary/10 rounded-xl text-primary"><UserSquare2 size={18} /></div>
                            <h3 className="text-base font-black uppercase italic tracking-tighter text-white">{t('accountManagement')}</h3>
                        </div>
            ...
            <div className="bg-card border border-border-custom p-6 md:p-8 rounded-[3rem] shadow-xl flex flex-col gap-6">
                <div className="flex items-center gap-3 border-b border-white/5 pb-4">
                    <div className="p-2 bg-red-500/10 rounded-xl text-red-500"><Heart size={18} fill="currentColor" /></div>
                    <h3 className="text-base font-black uppercase italic tracking-tighter text-white">{t('myLikes')}</h3>
                </div>
                {favoriteAssets.length === 0 ? (
                    <div className="py-12 flex flex-col items-center justify-center text-white/10 text-center space-y-4">
                        <Heart size={24} className="opacity-10" />
                        <p className="text-[10px] font-black uppercase tracking-widest leading-relaxed">{t('noFavorites')}</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 gap-4 max-h-[800px] overflow-y-auto pr-1 no-scrollbar">
